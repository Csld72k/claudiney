...
class UsersController{
  ...
  async update(request, response){
    ...
    if(userWithUpdatedEmail && userWithUpdatedEmail.id !== user.id){
      throw new AppError("Este e-mail já está sendo utilizado por outra pessoa")
    }
    ...
    if(password && !old_password){
      throw new AppError("É necessário informar a senha antiga para atualizar nova senha")
    }
